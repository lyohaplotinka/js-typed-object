import {checkTypes, clearType, getType} from "../types.mjs";
...
function createArrayPrivateField(object, type, initialValue, key) {
    ...
    if (initialValue !== undefined) setChecker(initialValue, initialValueType, cleanType, type)
    ...
    const privateFieldValue = {
        ...
        value: (initialValue === undefined && allowUndefined) ? undefined :  new Proxy(initialValue, {
            set(target, p, value) {
                this.$$checker(value)
                target[p] = value
                return true
